		...
		<>
			...
			>
				<a href={'https://github.com/djuarez2652/'} target={'_blank'}>
					<img src={GithubLogo} className={'h-full w-[32px] md:w-[38px]'} alt={'github'}/>
				</a>
				<a onClick={ copyToClipBoard } target={'_blank'}>
					<img src={GmailLogo} className={'h-full w-[32px] md:w-[38px]'} alt={'gmail'}/>
				</a>
				<a href={'https://www.linkedin.com/in/david-juarez-429603261/'} target={'_blank'}>
					<img src={LinkedInLogo} className={'h-full w-[32px] md:w-[38px]'} alt={'linkedin'}/>
				</a>
				{
					showCopy ?
						<div
						...
						>
							...
							<img src={X} className={'h-[15px] w-[15px] md:h-[20px] md:w-[20px] absolute left-[83%] top-[10%] md:left-[85%] md:top-[10%]'} onClick={ handleClose } alt={'X'}/>
						</div> :
						null
				}
			</div>
